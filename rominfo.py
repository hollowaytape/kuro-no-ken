...
# Codes whose handler calls 0x17b8 (mode_dispatch) as its first instruction.
# Pattern: CC 00 ptr_lo ptr_hi — mode byte 0x00 means next 2 bytes are a raw pointer.
# Generated by analyze_control_codes.py from BD.BIN dispatch table at 0x22d0.
# Previously this list included NOP/default entries (0x6e-0x7d, 0x99, 0x9f, etc.)
# and non-0x17b8 handlers (0x02, 0x03, 0x40, 0x69) which could cause false positive
# pointer matches. Those have been removed.
ZERO_POINTER_FIRST_BYTES = [0x08, 0x39, 0x3f, 0x41, 0x43, 0x46, 0x49, 0x4c,
                        0x50, 0x51, 0x52, 0x54, 0x55, 0x57, 0x5a, 0x5d,
                        0x5e, 0x5f, 0x60, 0x61, 0x64, 0x65, 0x66, 0x7e,
                        0x8b, 0x90, 0x94, 0xa0, 0xa1, 0xa4, 0xab, 0xb0,
                        0xb1, 0xb3, 0xb7, 0xbe]
