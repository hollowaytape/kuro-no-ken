...
ZERO_POINTER_FIRST_BYTES = [0x00, 0x02, 0x08, 0x39, 0x3f, 0x40, 0x41, 0x43, 0x46, 0x49,
                        ...
                        0xab, 0xaf,  0xb0, 0xb1, 0xb3, 0xb5, 0xb7, 0xbe, 0xc5, 0xcf,]
...
FILES = [
    ...
    BODFile(b'B.FA1', b'D010_S20.BSD', 0x81240, 0x1be, 0x351),
    BODFile(b'B.FA1', b'D010_X10.BSD', 0x813fe, 0x5e1, 0xd91),
    BODFile(b'B.FA1', b'D011_A20.BSD', 0x819e0, 0x183, 0x35b),
    BODFile(b'B.FA1', b'D011_B02.BSD', 0x81b64, 0x183, 0x35b),
    BODFile(b'B.FA1', b'D011_I10.BSD', 0x81ce8, 0x114, 0x21f),
    BODFile(b'B.FA1', b'D011_K12.BSD', 0x81dfc, 0x183, 0x35b),
    BODFile(b'B.FA1', b'D011_K22.BSD', 0x81f80, 0x183, 0x35b),
    BODFile(b'B.FA1', b'D011_S20.BSD', 0x82104, 0x1cf, 0x357),
    BODFile(b'B.FA1', b'D011_T20.BSD', 0x822d4, 0x1d4, 0x357),
    BODFile(b'B.FA1', b'D011_U20.BSD', 0x824a8, 0x1e0, 0x35b),
    BODFile(b'B.FA1', b'D011_X10.BSD', 0x82688, 0x1eb, 0x35d),
